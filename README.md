...
|---|---|---|---|
| **Sentiment‑Enhanced Forecasting** | Benchmark-driven financial sentiment index + stock return forecasting (FNSPID + FinBERT). | Jupyter Notebook, NLP | [Repo](https://github.com/Iman-hamdan/sentiment-enhanced-forecasting) |
| **AI Keyword Clustering** | AI-powered keyword clustering using BERT embeddings to group keywords by semantic similarity. | Python, BERT | [Repo](https://github.com/Iman-hamdan/ai-keyword-clustering) |
| **Drug Review Sentiment Analysis** | NLP model to classify patient drug reviews and extract actionable sentiment signals. | Jupyter Notebook, NLP | [Repo](https://github.com/Iman-hamdan/aai-501-group7-sentiment-analysis-drug-reviews) |
| **Diabetes Stats Model** | Health indicators analysis + hypothesis testing and modeling to predict diabetes likelihood. | Jupyter Notebook, ML | [Repo](https://github.com/Iman-hamdan/Diabetes-Stats-Model) |
| **Composer Classifier** | Classifies music composers from features/data (ML classification project). | Python, ML | [Repo](https://github.com/Iman-hamdan/composer-classifier) |
